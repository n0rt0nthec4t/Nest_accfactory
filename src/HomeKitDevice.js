...
export default class HomeKitDevice {
    ...
    async add(accessoryName, accessoryCategory, useHistoryService) {
        if (this.hap === undefined ||
            ...
            (this.#platform === undefined && typeof this.deviceData?.hkUsername !== 'string' && new RegExp(/^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$/).test(this.deviceData.hkUsername) === false)) {
        ...
        if (this.accessory === undefined &&
            ...
            this.accessory = new this.#platform.platformAccessory(this.deviceData.description, this.hap.uuid.generate(HomeKitDevice.PLUGIN_NAME + '_' + this.deviceData.uuid));
        ...
        if (this.accessory === undefined &&
            ...
            this.accessory = new this.hap.Accessory(accessoryName, this.hap.uuid.generate('hap-nodejs:accessories:' + this.deviceData.manufacturer.toLowerCase() + '_' + this.deviceData.serial_number));
